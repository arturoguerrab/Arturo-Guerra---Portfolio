...
const StateBar = () => {
	const style = {
		...
		stateBar: "h-full rounded-xl glassmorphism max-w-[1920px] ",
	...
	return (
		<header className={style.header}>
			<div className={style.stateBar + style.gridSM + style.gridMD}>
				<div className="col-span-3 grid grid-cols-3 sm:col-span-4  sm:grid-cols-4 xl:col-span-3  xl:grid-cols-3 xl:md:grid-cols-6 gap-1.5">
