...
const ExpressAPI = () => {
  return (
    <div className="h-full ">
			<div className="bg-[url('https://res.cloudinary.com/dbwomkmnq/image/upload/f_auto,q_auto/v1/Portfolio/cceomr1gao9nstahgniy')] bg-cover  h-2/5 rounded-t-3xl p-6 flex justify-end ">
				<img
			...
			<div className="bg-[#ffffffa6] h-3/5 rounded-b-3xl p-6 flex flex-col justify-between  ">
				<div>
					...
					<h2 className="font-bold text-3xl">Express API</h2>
